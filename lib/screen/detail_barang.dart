...
class _DetailBarangState extends State<DetailBarang> {
  ...
  void _handleEditItem(Map<String, dynamic> updatedItem) {
    setState(() {
      widget.item.addAll(
          updatedItem); // Update the current item data with the edited data
    });
  }
                                ...
                                MaterialPageRoute(
                                  builder: (context) => TambahBarang(
                                    ...
                                    onAddItem: (updatedItem) {
                                      ...
                                      widget.onEditItem(
                                          updatedItem); // Pass the updated item back
                                    },
                                  ),
                                ),
                              );
                                  ...
                                  actions: [
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        ...
                                        widget.onDeleteItem(widget
                                            .item); // Delete item from inventory
                                        Navigator.pop(
